    ...
    public static void bank(int r, int[] Ava, int[][] All,
        ...
        while (true) {
            ...
            if (isSafe == true) {
                ...
                System.out.print(".");
                t.sleep(1000);
                System.out.println("预计P" + p + "资源分配后，系统状态安全，分配成功！");
                System.out.println("分配情况：");
                ShowTest.showBank(p, All, Need, Ava);
                continue;
            }
            //如果不安全，分配作废
            if (isSafe == false) {
                ...
                System.out.print(".");
                t.sleep(1000);
                System.out.println("预计P" + p + "资源分配后，系统状态不安全，分配失败！");
                allocationRevocation(p, r, Ava, All, Need);//撤销分配
                continue;
            }
        }
    }
