...
public class Index {
    ...
    public void build(String inputPath) throws IOException {
        ...
        System.out.println("build finish!" + '\n' +
                "total time: " + (finishTime - startTime) + " ms");
        System.out.println("readFileTime: " + timer.readFileTime  + " ms"
                + '\n' + "buildForwardTime: " + timer.buildForwardTime  + " ms"
                + '\n' +  "buildInvertedTime: " + timer.buildInvertedTime  + " ms"
                +  '\n' + "logTime: " + timer.logTime  + " ms");
        System.out.println("=====================================");
    }
